...
const socialLinks = [
  { href: 'https://github.com/AlexSmiian', label: 'GitHub profile', icon: <GitHubIcon /> },
  { href: 'https://www.linkedin.com/in/oleksandr-smiian-a1a2031a8', label: 'LinkedIn profile', icon: <LinkedInIcon /> },
  { href: 'https://t.me/SmiianOleksandr', label: 'Contact on Telegram', icon: <TelegramIcon /> },
];
